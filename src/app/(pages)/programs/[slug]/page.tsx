...
import { CheckCircle, Clock, BarChart, Users, BookOpen, BrainCircuit } from 'lucide-react';
import Link from 'next/link';

const iconMap: { [key: string]: React.ElementType } = {
  DigitalMarketingPro: BrainCircuit,
  FullStackDevelopment: BookOpen,
  LeadershipManagement: Users,
  UXUIDesignFundamentals: BarChart,
};
...
export default function ProgramDetailPage({ params }: { params: { slug: string } }) {
  ...
  // A simple way to get an icon. In a real app this might be more robust.
...
// Generate static paths for each program
